...
if(isset($_POST['submit'])){
	...
	$sql1 ="SELECT * from passenger where email='$email' AND password='$password'";	//SQL query
	
	$r1 = $conn -> query($sql1);
	
	while($row1 = $r1->fetch_assoc()){
		
		$_SESSION["email"]=$_POST['email'];	//setting the session
	
	}

    echo "<script> alert ('Login Success')</script>";	//JS alert for validation 
...
<body>
    ...
    <div class="login-box">
        ...
        <div class="headingLogin">PASSENGER LOGIN</div> <!-- Login heading --> <br>

        <div class="navigationPassStaff">
            <a class="nav-option"  >Passenger</a>
            <a href="staffLogin.php" class="nav-option">Staff</a> 
        </div> <br>
        ...
        <p class="forget-password"><a href="forgetPassword.php">Forget Password ?</a></p> <br>
        <input type="submit" name="submit" value="Login">         <!-- Login button --> <br>
        
        <p class="pstyle">Dont have an Account ?  <a href="passengerRegister.php">Register Now</a></p> <br>
        </form>
    </div>
